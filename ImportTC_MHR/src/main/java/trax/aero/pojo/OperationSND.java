...
public class OperationSND implements Comparable<OperationSND>{

	@SuppressWarnings("removal")
	@Override
	public int compareTo(OperationSND e) {
		return Long.compare(new Long(this.tcNumber),(new Long(e.getTcNumber())));
	}
