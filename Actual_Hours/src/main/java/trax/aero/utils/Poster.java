...
public class Poster {
	...
	public boolean post(INT31_SND data, String URL) {
		{
			Client client = null;
			...
			try {
				...
				if(url.startsWith("https")) {
					...
					for(OrderSND r : data.getOrder()) {
							requests = requests +" (Order Number: " +r.getOrderNo() +", Operation: " +r.getOperationLine() + ", Transaction: " +r.getWoActualTransaction() + "),";
					}
