...
public class Actual_Hours_Data {
	...
	public ArrayList<INT31_SND> getActualHours() throws Exception{
		...
		String sqlActualHR = "SELECT DISTINCT W.RFO_NO, WT.OPS_NO, WA.EMPLOYEE, ABS(WA.HOURS * 60 + WA.MINUTES) AS TOTAL_MINUTES, \r\n" +
							 ...
							 "WA.WO = WT.WO AND WA.TASK_CARD = WT.TASK_CARD \r\n" +
							 "INNER JOIN WO_TASK_CARD_AFTER_WORK WTW ON \r\n" +
							 "WA.WO = WTW.WO AND WA.TASK_CARD = WTW.TASK_CARD WHERE W.RFO_NO IS NOT NULL AND WT.OPS_NO IS NOT NULL AND WA.INTERFACE_ESD_TRANSFERRED_FLAG IS NULL \r\n" +
