...
public class ServiceablelocationData implements IServiceablelocationData {
		...
		public ArrayList<MT_TRAX_SND_I28_4134_REQ> getRequests() throws Exception
		{
			...
			String sql = 
			"select distinct w.rfo_no, wsd.pn,wsd.pn_sn,w.wo,afa.CERTIFIED_BY , w.INSPECTION_LOT_NUMBER, wsd.pn_condition , wap.authority, w.INTERFACE_CODE\r\n" + 
			"from wo w\r\n" + 
			...
			"where \r\n" + 
			"w.rfo_no is not null and w.nh_wo is null and w.interface_esd_date is null \r\n" + 
